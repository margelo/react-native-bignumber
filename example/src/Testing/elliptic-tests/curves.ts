...
export function registerCurvedTests() {
  describe('Curve', function () {
    ...
    it('should dbl points on edwards curve using proj coordinates', function () {
      var curve = new elliptic.curve.edwards({
        p: new BN(
          '97ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff' +
            'ffffffffffffffffffffffffffffffffff3f',
          16,
          'le'
        ),
        q: new BN(
          '19973cfd137ee273272d101b28695e7ce1ee951ef221fbd5ffffffffff' +
            'ffffffffffffffffffffffffffffffffffff0f',
          16,
          'le'
        ),
        r: '8',
        ...
        // -67254 mod p
        d: new BN(
          'e1f8feffffffffffffffffffffffffffffffffffffffffffffffffff' +
        ...
        g: [
          new BN(
            '0396f77094ccc0eb985310e8bc7d519311846453b8ba232935640b2b0' +
              '340f868ae208d6ee95bf0e59103b2ead08d6f19',
            16,
            'le'
          ),
          new BN('11', 16, 'le'),
    ...
    it('should be able to find a point given y coordinate for all edwards curves', function () {
      var curve = new elliptic.curve.edwards({
        p: new BN(
          'f7' +
      ...
      var point = curve.pointFromY(
        '02' + 'f8ca771306cd23e929775177f2c213843a017a6487b2ec5f9b2a3808108ef2'
      );
    ...
    it('should work with secp256k1', function () {
      ...
      assert(
        p.mul(new BN('79be667e f9dcbbac 55a06295 ce870b07', 16)).validate()
      );
  ...
  describe('Point codec', function () {
    ...
    it(
      'should be able to encode/decode a mont curve point',
      makeMontTest({
        coordinates: {
